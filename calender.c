...
int main()
{
    ...
    while(1)
    {
        ...
        while(1)
        {
            gotoxy(20,20); printf("(*) Use LEFT, RIGHT, UP, and DOWN arrow keys to navigate.");
            gotoxy(20,22); printf("(*) Press P to go to a particular year and month.");
...
void display(int nyr,int nmonth,int tdays,int days[])
{
    ...
    gotoxy(56,6); printf("%s %d",month[nmonth-1],nyr); //Heading year and month display
